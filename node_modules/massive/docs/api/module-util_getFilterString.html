...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Module: util/getFilterString</title>
...
<div id="main">
    ...
    <h1 class="page-title">Module: util/getFilterString</h1>
...
<article>
    <div class="container-overview">
            ...
            <div class="description">Get a filter string or create one from an array of values.</div>
...
<span class="param-type">Array</span>
            ...
            <td class="description last">Source filter data.</td>
        </tr>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="lib_util_get-filter-string.js.html">lib/util/get-filter-string.js</a>, <a href="lib_util_get-filter-string.js.html#line5">line 5</a>
    </li></ul></dd>
